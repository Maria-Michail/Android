...
public class HomeRepository {
    ...
    private HomeRepository(Application application){
        ...
        Task task1 = new Task("do this thing today", true, "21-04-10", "11:30");
        Task task2 = new Task("also do this thing today", true, "21-04-10", "11:40");
        Task task3 = new Task("lastly do this thing today", false, "21-04-11", "11:50");
        //insert(task1);
        //insert(task2);
        //insert(task3);
